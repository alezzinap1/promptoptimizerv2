...
- [PRODUCTION_CHECKLIST.md](PRODUCTION_CHECKLIST.md) — go/no-go checklist
- [STREAMLIT_AUDIT.md](STREAMLIT_AUDIT.md) — текущий статус фич
- [WEB_MIGRATION_PATH.md](WEB_MIGRATION_PATH.md) — путь к FastAPI + React
